...
INSERT INTO Daerah_Tangkap VALUES
...
INSERT INTO Hasil_Tangkapan VALUES
(5001, 1, 1, 301, 500),
(5002, 2, 2, 302, 400),
(5003, 3, 3, 303, 350),
(5004, 4, 4, 304, 450),
...
INSERT INTO Pendaratan_Ikan VALUES
...
INSERT INTO Penjual_Ikan VALUES
(101, 'Pak Budi', 1),
(102, 'Pak Slamet', 2),
(103, 'Pak Joko', 3),
(104, 'Bu Siti', 4),
...
INSERT INTO Pembeli_Ikan VALUES
...
SELECT 
    p.id_penjual,
    p.nama_penjual,
    COUNT(pb.id_pembeli) AS total_pembeli
FROM Penjual_Ikan p
